...
export default function HomePage() {
  ...
  return (
    <Container>
      ...
      <Separator/>
      <Flex direction={"column"} align={"center"} justify={"center"} m={5}>
        <Heading size={"2xl"} mb={2}>Projects</Heading>
        <Stack gap={4} direction={"row"} wrap={"wrap"} align={"center"} justify={"center"} m={5}>
          ...
          <Card.Root width="320px" variant={"elevated"}>
            <Card.Body gap="2">
              ...
              <Card.Description>
                Aktiver Mitentwickler von TikFinity Widgets. Für ein besseres und angenehmeres Streamen bei TikTok Live.
              </Card.Description>
            </Card.Body>
            <Card.Footer justifyContent="flex-end">
